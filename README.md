...
This table lists the configuration variables required to operate PagerDuty. These variables are specified when configuring a PagerDuty asset in Splunk SOAR.
